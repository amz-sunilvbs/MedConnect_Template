...
from livekit.plugins import deepgram, openai, silero, aws, tavus, bithuman
import aiohttp
import os

logger = logging.getLogger("vision-agent-with-tools")
    ...
    def __init__(self) -> None:
        ...
        super().__init__(
            instructions="""
                ...
                DO NOT send the thinking tags in your response.
            """,
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("staring Tavus Avatar...\n")
